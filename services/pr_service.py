...
class PRService:
    ...
    async def _create_branch(self, branch_name: str) -> bool:
        ...
        # Temporarily skip git operations for testing
        print(f"[SKIP GIT] Would create branch: {branch_name}")
        return True
    ...
    async def _add_decision_file(self, decision: Decision, branch_name: str):
        ...
        # Stage the file
        print(f"[SKIP GIT] Would stage file: {filename}")
...
"""
        ...
        print(f"[SKIP GIT] Would commit with message: {commit_message[:50]}...")
