...
def create_backup():
    ...
    files_to_backup = ["src/web/app.py", "services/pr_service.py", ".env", "requirements.txt", "data/"]
...
def create_directories():
    ...
    dirs = [".backups", "logs", "data/pr_drafts", "data/decisions", "data/debates", "data/evolutions"]
