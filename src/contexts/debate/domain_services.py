...
from .value_objects import (
    Argument, Topic, Consensus, ConsensusLevel, 
    DecisionCriteria, DebateMetrics, ArgumentType
)
...
class ComplexityAssessment:
    ...
    def _assess_impact(self, question: str, context: Dict[str, Any]) -> str:
        ...
        high_impact_keywords = ['architecture', 'system', 'major', 'critical', 'fundamental']
