...
from domain.models import (
    Decision, Debate, DecisionType, ImplementationAssignee
)
...
class TestDelegationService:
    ...
    def test_determine_implementation_assignment_simple(self, delegation_service, simple_decision):
        ...
        assignee, complexity = delegation_service.determine_implementation_assignment(
            simple_decision
        )
    ...
    def test_assess_implementation_complexity_with_debate(self, delegation_service, complex_decision, sample_debate):
        ...
        complexity = delegation_service._assess_implementation_complexity(
            complex_decision, sample_debate
        )
    ...
    def test_determine_reviewer(self, delegation_service):
        ...
        assert delegation_service.determine_reviewer(
            ImplementationAssignee.CLAUDE
        ) == "gemini-bot"
        
        assert delegation_service.determine_reviewer(
            ImplementationAssignee.GEMINI
        ) == "codex"
        
        assert delegation_service.determine_reviewer(
            ImplementationAssignee.HUMAN
        ) == "human"
