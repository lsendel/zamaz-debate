...
class TestWebAPI:
    ...
    def test_decide_endpoint_simple(self, client):
        ...
        with patch("src.web.app.nucleus") as mock_nucleus:
            ...
            response = client.post("/decide", json={"question": "What color should we use?", "context": "For the logo"})
    ...
    def test_decide_endpoint_complex(self, client):
        ...
        with patch("src.web.app.nucleus") as mock_nucleus:
            ...
            response = client.post(
                "/decide",
                json={"question": "Should we migrate to microservices?", "context": "Current monolith is slow"},
            )
    ...
    def test_evolve_endpoint(self, client):
        ...
        with patch("src.web.app.nucleus") as mock_nucleus:
            mock_nucleus.evolve_self = AsyncMock(
                return_value={
    ...
    def test_decide_empty_question(self, client):
        ...
        response = client.post("/decide", json={"question": "", "context": "Some context"})
        assert response.status_code == 422  # Validation error
