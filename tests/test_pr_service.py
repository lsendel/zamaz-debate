...
class TestPRService:
    ...
    def test_generate_pr_title(self, pr_service_enabled):
        ...
        title = pr_service_enabled._generate_descriptive_title(decision, "[Complex] Should we implement caching?")
    ...
    def test_generate_pr_title_evolution(self, pr_service_enabled):
        ...
        title = pr_service_enabled._generate_descriptive_title(decision, "[Evolution] System self-improvement")
